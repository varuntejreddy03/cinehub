        ...
        <div className="pricing-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 24, maxWidth: 860, margin: '0 auto' }}>
          {plans.map((plan, idx) => (
            <div
              ...
              style={{
                ...
                background: plan.popular
                  ...
                  : plan.wedding
                  ? 'linear-gradient(160deg, #0f0e00 0%, #161616 60%)'
                  : '#161616',
                border: plan.popular
                ...
                boxShadow: plan.popular
                  ...
                  : plan.wedding
                  ? '0 0 40px rgba(212,175,55,0.08), 0 20px 40px rgba(0,0,0,0.4)'
              ...
              onMouseEnter={(e) => {
                ...
                d.style.boxShadow = plan.popular
                  ...
                  : plan.wedding
                  ? '0 0 60px rgba(212,175,55,0.15), 0 24px 48px rgba(0,0,0,0.5)'
            ...
            >
              ...
              <div style={{ height: 1, background: plan.wedding ? 'rgba(212,175,55,0.12)' : 'rgba(255,255,255,0.06)', marginBottom: 22 }} />
                ...
                {plan.features.map((f) => (
                  <li key={f} style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none"
                      stroke={plan.wedding ? '#D4AF37' : '#D0021B'}
